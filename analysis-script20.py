if __name__ == "__main__":
    ...
    with open('k-20.0-h-magnitude-0.25-M-11-all-qmc-samples.pickle','rb') as f:
        qmc = pickle.load(f)
    ...
    if qoi_num == 1:
        plt.title('QMC error for point evaluation at origin for k = 20')
    elif qoi_num == 0:
        plt.title('QMC error for integral of solution for k = 20')
